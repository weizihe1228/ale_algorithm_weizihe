...
class AtariEnv:
    def __init__(self, env_name='ALE/AirRaid-v5', frame_skip=4, frame_stack=4, screen_size=84, render_mode='rgb_array'):
    ...
    def reset(self):
        ...
        self.previous_lives = info.get('lives', 3)  # 假设初始3条命
